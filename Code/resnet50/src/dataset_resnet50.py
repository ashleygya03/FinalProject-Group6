"""Data handling class for the ASL project (ResNet50 pipeline)."""
import os
import shutil
import pandas as pd
import splitfolders
...
from src.config_resnet50 import BASE_PATH, WORKING_PATH, CATEGORIES, IMAGE_SIZE, BATCH_SIZE
...
class ASLDataset:
    ...
    def get_generators(self):
        """Creates ImageDataGenerators with ResNet50 preprocessing.

        Train generator applies data augmentation consistent with the notebook:
        rotation, zoom, horizontal/vertical shift, shear, and brightness.
        """
