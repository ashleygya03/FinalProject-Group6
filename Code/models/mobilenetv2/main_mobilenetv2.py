...
from configs.config import IMAGE_SIZE, IMG_CHANNEL, N_CLASSES, MOBILENETV2_CONFIG, TRAINING_CONFIG, CALLBACKS_CONFIG
from models.src.dataset import ASLDataset
from models.src.model_mobilenetv2 import ASLModel
...
OUTPUT_DIR = MOBILENETV2_CONFIG["output_dir"]

CHECKPOINT_PATH = MOBILENETV2_CONFIG["checkpoint_path"]

EPOCHS_PHASE1 = TRAINING_CONFIG["epochs_phase1"]
EPOCHS_PHASE2 = TRAINING_CONFIG["epochs_phase2"]

PHASE1_LR = MOBILENETV2_CONFIG["learning_rates"]["phase1"]
PHASE2_LR = MOBILENETV2_CONFIG["learning_rates"]["phase2"]

FINE_TUNE_AT = MOBILENETV2_CONFIG["fine_tune_at"]
