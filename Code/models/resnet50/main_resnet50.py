"""Main module to run the ASL model training and evaluation (ResNet50)."""
import os
import numpy as np
import json
...
from configs.config import IMAGE_SIZE, IMG_CHANNEL, N_CLASSES, CATEGORIES, TRAINING_CONFIG, RESNET50_CONFIG, CALLBACKS_CONFIG
from models.src.dataset import ASLDataset
from models.src.model_resnet50 import ASLModel
