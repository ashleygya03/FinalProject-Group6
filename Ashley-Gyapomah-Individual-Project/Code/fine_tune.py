...
--------------------------------
Unfreezes the top layers of the pre-trained MobileNetV2 base to allow 
for gradient updates at a reduced learning rate. This stage optimizes 
the model for the specific nuances of the ASL hand-gesture dataset 
to achieve higher precision and robust feature extraction.
"""
