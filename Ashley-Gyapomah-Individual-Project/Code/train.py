...
-------------------------
Initializes the MobileNetV2 backbone with ImageNet weights and replaces 
the top layers with a custom global health-tech classification head. 
Implements categorical cross-entropy loss and early stopping to prevent 
overfitting on the initial training epochs.
"""
