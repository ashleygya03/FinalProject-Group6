...
-----------------------------------
Handles image augmentation, normalization, and train/val/test splitting.
Standardizes input images to 224x224 and applies MobileNetV2-specific 
scaling to prepare raw data for the CNN architecture.
"""
